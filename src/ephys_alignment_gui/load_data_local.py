...
class LoadDataLocal:
    ...
    def get_xyzpicks(self):
        ...
        xyz_picks[:,1] = xyz_picks[:, 1] * (self.brain_atlas.spacing[1] * 1000)
        xyz_picks[:,2] = xyz_picks[:, 2] * (self.brain_atlas.spacing[2] * 1000)
        xyz_picks[:,0] = xyz_picks[:, 0] * (self.brain_atlas.spacing[0] * 1000)
